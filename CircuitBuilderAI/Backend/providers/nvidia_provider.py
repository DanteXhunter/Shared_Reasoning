...
class NvidiaProvider(LLMProvider):
    def __init__(self, variante: str = "nemotron"):
        ...
        self.model = MODELOS.get(variante, "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning")
    ...
    async def analizar_esquematico(self, imagen_bytes: bytes, mime_type: str) -> dict:
        ...
        try:
            ...
            texto_raw = mensaje.content or getattr(mensaje, "reasoning_content", None) or ""
